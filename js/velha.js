window.onload = (function(){
		...
		var total= new Array();
		total = [0,0];
		var vitoria = [7,56,448,73,146,292,273,84,201,294,89,75,
		308,420,147,275,401,402,464,450,58,184,456,480,481,340,337,
		277,57,305,118,93,117,85,211,210,213,281,356,15];
		var valor_1;
		var valor_2;
		$( "#tabs" ).tabs();
		$( "div.square" ).html(" ");
